...
import ACLogo from "../assets/images/logos/discord emoji.png";
...
const Navbar = () => {
    ...
    const underlineIfActive = ({isActive}) => `${isActive ? "box-border transition-all border-black border-b-2" : ""}`;
    ...
    return (<div className="sticky top-0 z-10 font-montserrat w-full bg-AC_Orange p-1">
