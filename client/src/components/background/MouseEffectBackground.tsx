...
const MouseEffectBackground: React.FC = () => {
  ...
  return (
    <div className="absolute top-0 left-0 w-full h-full">
      <div className="grid sm:grid-cols-[repeat(21,minmax(0,1fr))] md:grid-cols-[repeat(28,minmax(0,1fr))] xl:grid-cols-[repeat(35,minmax(0,1fr))] gap-0 w-full h-full">
        {squares.length > 0 &&
          squares[0].length == columns &&
